...
public class RefreshableView extends LinearLayout implements OnTouchListener {
	...
	/**
	 * 涓轰簡闃叉涓嶅悓鐣岄潰鐨勪笅鎷夊埛鏂板湪涓婃鏇存柊鏃堕棿涓婁簰鐩告湁鍐茬獊锛屼娇鐢╥d鏉ュ尯鍒�
	 */
	private int mId = -1;
	 ...
	 * STATUS_REFRESHING 闁告粣鎷稴TATUS_REFRESH_FINISHED
	 */
	...
	/**
	 *  鍦ㄨ鍒ゅ畾涓烘粴鍔ㄤ箣鍓嶇敤鎴锋墜鎸囧彲浠ョЩ鍔ㄧ殑鏈�澶у��
	 */
	...
	/**  
	 * 褰撳墠鏄惁鍙互涓嬫媺銆傚彧鏈塋istView婊氬姩鍒板ご鐨勬椂鍊欐墠鍏佽涓嬫媺
	 */
	...
	/**
	 * 杩涜涓�浜涘叧閿�х殑鍒濆鍖栨搷浣滐紝姣斿锛氬皢涓嬫媺澶村悜涓婂亸绉昏繘琛岄殣钘忥紝缁橪istView娉ㄥ唽Touch浜嬩欢 
	 **/
	@Override
	...
	/**
	 *  褰揕istView琚Е鎽告椂璋冪敤锛屽叾涓鐞嗕簡鍚勭涓嬫媺鍒锋柊鐨勫叿浣撻�昏緫
	 */
	@Override
	 ...
	 *  鐩戝惉鍣ㄧ殑瀹炵幇	
	 *  @param id
	 *  涓轰簡闃叉涓嶅悓鐣岄潰鐨勪笅鎷夊埛鏂板湪涓婃鏇存柊鏃堕棿涓婁簰鐩告湁鍐茬獊锛� 璇蜂笉鍚岀晫闈㈠湪娉ㄥ唽涓嬫媺鍒锋柊鐩戝惉鍣ㄦ椂涓�瀹氳浼犲叆涓嶅悓鐨刬d    
	 */
	...
	public interface PullToRefreshListener {
		...
		/**
		 *鍒锋柊鏃朵細鍘诲洖璋冩鏂规硶锛屽湪鏂规硶鍐呯紪鍐欏叿浣撶殑鍒锋柊閫昏緫銆傛敞鎰忔鏂规硶鏄湪瀛愮嚎绋嬩腑璋冪敤鐨勶紝
		 * 浣犲彲浠ヤ笉蹇呭彟寮�绾跨▼鏉ヨ繘琛岃�楁椂鎿嶄綔銆�
		 */
		void onRefresh();
